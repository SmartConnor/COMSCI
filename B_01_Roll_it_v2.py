...
while comp_score < game_goal and user_score < game_goal:
    ...
    # if user has fewer points, that start the game
    if user_points < comp_points:
        print("You because your initial roll was less than the computer\n")
    ...
    # Output rounds loop - Update score with rounds points, only add points to the score of the
